...
export default class extends BaseSchema {
  ...
  public async up () {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.string('trh_convenio')
      table.string('trh_fecha_convenio')
      ...
      table.string('trh_documento_convenio')
      table.string('trh_nombre_original_convenio')
      table.string('trh_ruta_archivo_convenio')
      table.string('trh_observacion')
